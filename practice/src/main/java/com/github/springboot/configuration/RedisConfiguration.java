...
/**
 * {@code EnableCacheing} 开启注解形式的redis缓存使用 AbstractCacheResolver.resolveCaches 一旦注册一个cacheName,那么必须把所有的cachename都进行注册，不然会产生异常
 *
 * TODO 升级到2.x版本后，需要更新redis的使用
 */
@EnableCaching
...
//        SyncRedisCacheManager cacheManager = new SyncRedisCacheManager(redisTemplate, RedisCacheConfiguration.defaultCacheConfig());
...
//    }
    ...
    public RedisTemplate<String, String> stringRedisTemplate(RedisConnectionFactory factory) throws UnknownHostException {
